...
date: "2023-05-21"
---
## Read the data files and rename the variables as the template
...
```{r}
cantonese_realf0.long <- read_csv("./datafiles/Cantonese_realf0_forf0check.csv", col_names = TRUE,show_col_types = FALSE)
...
## Next step
- [] Visualise the wrong f0 contour
